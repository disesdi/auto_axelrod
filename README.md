...
* returns a python list of all strategies, more info [here](https://axelrod.readthedocs.io/en/fix-documentation/tutorials/advanced/strategies.html?highlight=axl.all_strategies#accessing-strategies)
